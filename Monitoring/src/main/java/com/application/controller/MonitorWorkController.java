...
public class MonitorWorkController {
	...
	public ResponseEntity<String> getMonitorWork(@PathVariable Map<String, String> pathParams,
			@RequestParam Map<String, String> requestParams, HttpServletRequest request) throws Exception {
		ResponseEntity<String> response = null;

		response = framework.init(requestParams, pathParams, "MonitorWork", request, null).invoke();
		return response;
	}
}
