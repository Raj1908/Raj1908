...
public class CustomerController {
	...
	public ResponseEntity<String> getCustomer(@PathVariable Map<String, String> pathParams,
			@RequestParam Map<String, String> requestParams, HttpServletRequest request) throws Exception {
		ResponseEntity<String> response = null;

		response = framework.init(requestParams, pathParams, "Customer", request, null).invoke();
		return response;
	}
}
